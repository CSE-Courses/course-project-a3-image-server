                    ...
                    <div class="card-body">
                        ...
                        <form>
                            <div class="form-group">
                                <label for="exampleInputEmail1" style="text-align: left">The Weather  in reference to this picture is </label>
                                <input type="text" class="form-control" value="Cloudy" id="" aria-describedby="emailHelp">
                                <small id="emailHelp" class="form-text text-muted">some  information can be written here....</small>
                            </div>
                        </form>
